...
;   scans      (2-D real)       - resulting scans (sfu/arcsec). 1-D - scans themselves, 2-D - frequencies
...
;   freq_set   (1-D real)       - set of frequencies used for scan calculation. See Comment (*)
;   out_data   (3-D real)       - radiomaps to calculate scans ((1,2-D - coordinates, 3-D - frequencies)). See Comment (**) 
